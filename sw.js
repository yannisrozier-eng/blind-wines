const CACHE="blind-wine-v443-discovery-scroll-fix";
const SHELL=["./","./index.html","./config.js","./manifest.webmanifest","./styles.css","./favicon-32.png","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./og-preview.jpg","./js/core.js","./js/blind-guide.js","./js/auth.js","./js/game.js","./js/discovery.js","./js/challenge.js","./js/player.js","./js/reveal.js","./js/host.js","./js/post-event.js","./js/history.js","./js/main.js"];
